...
github_doc_root = 'https://github.com/zcattacz/pjon_wiki/master/'
...
man_pages = [
    (master_doc, 'pjon_wiki', u'PJON Wiki',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pjon_wiki', u'PJON Wiki',
   author, 'pjon_wiki', 'PJON - Padded Jittering Operative Network.',
   'network'),
]
...
# app setup hook
def setup(app):
    app.add_config_value('pjon_wiki_config', {
