PJON is an opensource 10-bit multimaster communications bus system standard. It is designed to provide the community with a new and easy way to communicate data and build networks of devices. This set of rules is designed for Internet of things and opensource embedded applications and proved to be effective on different media like electricity, radio frequency and light. A Bit has a duration of 20 microseconds, transfer speed is 4.16kB/s or 41666 baud. This setup is selected to provide an acceptable bandwidth but also to be easily implemented bitbanged or software emulated on low frequency clock embedded systems.
### Basic concepts
