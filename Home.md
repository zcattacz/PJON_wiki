PJON is an opensource 10-bit multimaster communications bus system standard. It is designed to provide the community with a new and easy way to communicate data and build networks of devices. This set of rules is designed for Internet of things and opensource embedded applicaziones and proved to be effective on different media like electricity, radio frequency and light. The communication speed is set to a bit duration of 20 microseconds with a transfer speed of 4.16kB/s or 41666 baud.
### Basic concepts
