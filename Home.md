The PJON is an opensource multimaster communications bus system standard. It is designed to provide the community with a new, easy to implement way to communicate data and build networks of devices.
```cpp  
