The PJON Standard is an opensource communication bus system concept, it is designed to provide the community with a new, easy to implement way to communicate data and build networks of devices.
```cpp  
