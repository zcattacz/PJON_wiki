...
Note: 
- Add 10KOhm pulldown resistors on both ends if converter has no integrated pullup resistors. 
- Add 1-2KOhm  pulldown resistors on both ends if converter has integrated pullup resistors.
