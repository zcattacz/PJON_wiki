...
Note: 
- Add 10K pulldown resistors on both ends if the converter has no integrated pullup resistors. 
- Add 1K  pulldown resistors on both ends if the converter has integrated pullup resistors.
